//NOTE: SINCE I USED MANY GLOBAL FUNCTIONS, MAIN CODE STARTS AT LINE 440
//I THOUGHT SINGLE FILE IS EASIER FOR READING.I HOPE I DON'T TIRE YOU OUT
//IF IT WOULD BE BETTER TO WRITE IN DIFFERENT FILES (MAIN,GLOBAL FUNCTIONS,..)
//PLEASE GIVE ME FEEDBACK SO I DO IT IN NEXT HOMEWORKS.
#include <iostream>
#include <cstdlib>
#include <time.h>
#include <string>
